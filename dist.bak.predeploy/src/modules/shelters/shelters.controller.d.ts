...
export declare class SheltersController {
    ...
    getOrganizerProfile(id: string, userId?: string): Promise<{
        success: boolean;
        data: {
            id: string;
            name: string;
    ...
    getNearby(lat: number, lng: number, limit: number): any;
    getFollowedShelters(userId: string): Promise<{
        id: string;
        name: string;
        address: string;
        imageUrl: string;
    ...
    toggleFollow(id: string, userId: string): Promise<{
        success: boolean;
        isFollowed: boolean;
