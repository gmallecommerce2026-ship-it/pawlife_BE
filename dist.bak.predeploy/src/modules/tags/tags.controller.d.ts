...
export declare class TagsController {
    ...
    getTagReportDetail(id: string, req: any): Promise<{
    ...
    createReport(createTagReportDto: CreateTagReportDto, req: any): Promise<{
        tag: {
            pet: ({
                owner: {
                    id: string;
    ...
    getNearbyLostPets(lat: string, lng: string, radius?: string): Promise<any>;
}
