...
async function main() {
    ...
    const petData = [
        { name: 'Milo', species: 'Dog', breed: 'Golden Retriever', age: 2, gender: client_1.PetGender.MALE, size: client_1.PetSize.LARGE, color: 'Vàng', shelterId: shelter1.id, imageUrl: 'https://loremflickr.com/400/400/dog' },
        { name: 'Miu', species: 'Cat', breed: 'Mèo mướp', age: 1, gender: client_1.PetGender.FEMALE, size: client_1.PetSize.SMALL, color: 'Vằn', shelterId: shelter1.id, imageUrl: 'https://loremflickr.com/400/400/cat' },
        { name: 'Tomy', species: 'Cat', breed: 'Mèo Anh Lông Ngắn', age: 1, gender: client_1.PetGender.MALE, size: client_1.PetSize.MEDIUM, color: 'Xám', shelterId: shelter2.id, imageUrl: 'https://loremflickr.com/400/400/cat,grey' },
        { name: 'Rex', species: 'Dog', breed: 'Becgie', age: 5, gender: client_1.PetGender.MALE, size: client_1.PetSize.LARGE, color: 'Đen Vàng', shelterId: shelter2.id, imageUrl: 'https://loremflickr.com/400/400/germanshepherd' },
        { name: 'Cam', species: 'Cat', breed: 'Mèo vàng', age: 2, gender: client_1.PetGender.MALE, size: client_1.PetSize.SMALL, color: 'Cam', shelterId: shelter3.id, imageUrl: 'https://loremflickr.com/400/400/orange,cat' },
        { name: 'Husky', species: 'Dog', breed: 'Husky Sibir', age: 3, gender: client_1.PetGender.MALE, size: client_1.PetSize.LARGE, color: 'Xám Trắng', shelterId: shelter3.id, imageUrl: 'https://loremflickr.com/400/400/husky' },
    ];
    for (const pet of petData) {
        await prisma.pet.create({
            data: {
                ...
                size: pet.size,
                color: pet.color,
                status: client_1.PetStatus.AVAILABLE,
                isVaccinated: true,
